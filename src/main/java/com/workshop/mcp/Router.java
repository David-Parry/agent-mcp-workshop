        ...
        switch (uniqueKey) {
            ...
            case PROMPTS_LIST -> {
                ...
                if (this.roots.isEmpty()) {
                    builder.withPromptArgument("root_directory", "The root directory to start the search from. If " +
                            "not provided, the search will start from the project root.", true);
                }
                success(message.id(), builder.build());
            }
            case PROMPTS_GET -> {
