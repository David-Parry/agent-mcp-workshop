 ...
 * a message and a JSON schema that defines the structure of the expected response.
 * This allows the server to gather structured input from users in a standardized way.
 * </p>
 * 
 * @param message the message to display to the user when requesting information
